...
import { UserWithRelations } from "@/app/_utils/db";
import useForm, { Errors } from "@/app/_utils/useForm";
import { useSessionSetEffect } from "@/app/_utils/useSessionSetEffect";
import CreatorProfileSkeleton from "@/app/_components/skeleton/CreatorProfileSkeleton";

export type UpdateCreatorFormSchemaType = {
    email: string
    firstName: string
    lastName: string
    phoneNumber: string
...
export default function Page() {
    ...
    const form = useForm<UpdateCreatorFormSchemaType>();
    ...
    const submit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        form.put(`/api/users/creators/${user?.id}`, {
