...
import { formatInstagramMetric } from "../_utils/helpers"
import { bookingStatusBadges } from "../_utils/constants"
import ProfilePicture from "./ProfilePicture"
import PrimaryButton from "./PrimaryButton"

interface BusinessBookingCardProps {
    booking: BookingWithRelations
}

export default function BusinessBookingCard({ booking }: BusinessBookingCardProps) {
