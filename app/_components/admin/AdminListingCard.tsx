...
export default function AdminListingCard({ listing }: AdminListingCardProps) {
    ...
    */
    async function onListingEnableChange(val: boolean) {
        ...
        try {
            // This will verify to TRUE if the user is admin!
            ...
            revalidatePath(`/dashboard/businesses/profile/${listing.business.id}/listings`)
    ...
    return (
        <div className="ring-1 ring-gray-200 shadow-md rounded-md p-4 h-full flex flex-col">
            ...
            <div className="w-full flex justify-between items-center">
                ...
                <Link href={`/dashboard/businesses/profile/${listing.business.id}/listings/edit/${listing.id}`}>
                    <SecondaryButton>
                        Edit
                    </SecondaryButton>
                </Link>
