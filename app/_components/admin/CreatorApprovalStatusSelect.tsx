...
interface CreatorApprovalStatusSelectProps {
    status: ApprovalStatus
    creatorId: string
}

export default function CreatorApprovalStatusSelect({ status, creatorId }: CreatorApprovalStatusSelectProps) {
    ...
    async function changeStatus() {
        ...
        await updateCreatorApprovalStatus(creatorId, selected);
    ...
    return (
        <>
            <ConfirmationModal
                ...
                title="Update Creator Approval Status"
                description="Updating a creator approval status will automatically send an email (if approving or rejecting), and create a new entry for Instagram Verification in the db. Are you sure you want to continue?"
                buttonText="Update"
