...
export default function Page() {
    ...
    const getBusiness = async () => {
        ...
        const businessResponse = await fetch(`/api/businesses/${session.user.businessId}`, {
            method: "GET",
            headers: {
    ...
    useSessionSetEffect(getBusiness, session);
        ...
        <div>
            {
                loadingPage ? (
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3">
                            ...
                            <form onSubmit={submit} className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                                ...
                                <div className="sm:col-span-4">
                                    ...
                                    <div className="mt-1">
                                        <PhotoInput defaultValue={business?.logo || ""} onChange={(logo: string) => form.setData("logo", logo)} />
                                    </div>
                                ...
                                <div className="col-span-full">
                                    <InputLabel htmlFor="description" name="Description" required={true} />
                                    <div className="mt-1">
                                        <InputTextArea
                                            name="description"
                                ...
                                <div className="sm:col-span-3">
                                    <InputLabel htmlFor="cuisineType" name="Cuisine Type" required={true} />
                                    <div className="mt-1">
                                        <InputText
                                            name="cuisineType"
                                            value={form.data.cuisineType}
                                            onChange={e => form.setData('cuisineType', e.target.value)}
                                        />
                                    </div>
                                ...
                                <div className="sm:col-span-3">
                                    <InputLabel htmlFor="type" name="Business Type" required={true} />
                                    <div className="mt-1">
                                        <InputSelect
                                            name="type"
                                ...
                                <div className="sm:col-span-3">
                                    <InputLabel htmlFor="email" name="Business Email" required={true} />
                                    <div className="mt-1">
                                        <InputText
                                            name="email"
                                ...
                                <div className="col-span-full">
                                    ...
                                    >
                                        To change your Instagram handle, please contact us.
                                    </div>
                                </div>
                        ...
                        {/* Edit Locations */}
                        {business?.locations ? business.locations.map((location: Location) => (
                            <div key={location.id} className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3">
                                <div>
                                    <h2 className="text-base font-semibold leading-7 text-gray-900">{location.name ? location.name : `${business.name} - Location`}</h2>
                                    <p className="mt-1 text-sm leading-6 text-gray-600">Edit the information for this location.</p>
                                </div>
                        ...
                        <div className="grid grid-cols-1 gap-x-8 gap-y-10 md:grid-cols-3">
                            <div>
                                <h2 className="text-base font-semibold leading-7 text-gray-900">Add more Locations</h2>
                                <p className="mt-1 text-sm leading-6 text-gray-600">Use this section to add more Locations to your business.</p>
                            </div>
