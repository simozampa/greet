...
import BusinessBookingActions from "@/app/dashboard/bookings/[booking_id]/BusinessBookingActions";
...
export default async function Page({
  ...
  return (
    <>
      <Link
        href={`/dashboard/businesses/profile/${booking.business.id}/bookings`}
      >
      ...
      <div className="mt-4 max-w-7xl">
          ...
          <div className="sm:flex sm:items-start sm:justify-between">
                  ...
                  {booking.status === BookingStatus.APPROVED && (
                    <>
                      ...
                      <Link
                        ...
                        href={`/dashboard/listings/edit/${booking.listing.id}`}
                      >
            ...
            <div className="mt-3 sm:ml-4 sm:mt-0">
              <div className="mt-4 flex flex-wrap justify-end sm:ml-6 sm:mt-0 sm:flex-shrink-0">
                ...
                booking.status === BookingStatus.APPROVED ? (
                  <p className="mt-1 text-xs text-gray-500 text-right w-full">
                    {booking.confirmedSlot}
                  </p>
                ) : (
                  <p className="mt-1 text-xs text-gray-500 text-right w-full">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm leading-6 text-gray-500">
                  Review information about {booking.user.firstName} and their
                  social profile below
                </p>
              </div>
              <div className="">
                <a
                  ...
                  target="_blank"
                  href={`https://www.instagram.com/${booking.user.instagramAccount?.username}/`}
                >
            ...
            <dl className="divide-y divide-gray-100">
                ...
                <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 flex items-center">
                  <div className="relative h-8 w-8 flex-shrink-0 rounded-full bg-gray-100 mr-2">
                    <ProfilePicture
                      size="4rem"
                      pictureUrl={
                        booking.user.instagramAccount?.profilePictureUrl
                      }
                      name={
                        booking.user?.firstName + " " + booking.user.lastName
                      }
              ...
              <div className="col-span-full sm:py-10 flex">
                <dl className="col-span-full grid grid-cols-1 gap-px bg-gray-900/5 sm:grid-cols-5 w-full">
                  <div className="flex flex-wrap flex-col items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 sm:px-6 xl:px-8 py-4 sm:py-0">
                    <dt className="text-sm font-medium leading-6 text-gray-900 flex-1">
                      Total Followers
                    </dt>
                    <dd className="flex flex-nowrap sm:flex-wrap items-baseline text-3xl font-semibold text-gray-900 w-full flex-none leading-10 tracking-tight">
                      {formatInstagramMetric(
                        booking.user.instagramAccount?.followersCount
                      )}
                      <span className="w-full ml-2 sm:ml-0 text-xs font-medium text-gray-500">
                        Lifetime
                      </span>
                    </dd>
                  </div>
                  ...
                  <div className="flex flex-wrap flex-col items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 sm:px-6 xl:px-8 py-4 sm:py-0">
                    ...
                    <dd className="flex flex-nowrap sm:flex-wrap items-baseline text-3xl font-semibold text-gray-900 w-full flex-none leading-10 tracking-tight">
                      {formatInstagramMetric(
                        booking.user.instagramAccount?.totalImpressions
                      )}
                      <span className="w-full ml-2 sm:ml-0 text-xs font-medium text-gray-500">
                        Last 30 days
                      </span>
                  ...
                  <div className="flex flex-wrap flex-col items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 sm:px-6 xl:px-8 py-4 sm:py-0">
                    ...
                    <dd className="flex flex-nowrap sm:flex-wrap items-baseline text-3xl font-semibold text-gray-900 w-full flex-none leading-10 tracking-tight">
                      {formatInstagramMetric(
                        booking.user.instagramAccount?.totalReach
                      )}
                      <span className="w-full ml-2 sm:ml-0 text-xs font-medium text-gray-500">
                        Last 30 days
                      </span>
                  ...
                  <div className="flex flex-wrap flex-col items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 sm:px-6 xl:px-8 py-4 sm:py-0">
                    ...
                    <dd className="flex flex-nowrap sm:flex-wrap items-baseline text-3xl font-semibold text-gray-900 w-full flex-none leading-10 tracking-tight">
                      {formatInstagramMetric(
                        booking.user.instagramAccount?.totalProfileViews
                      )}
                      <span className="w-full ml-2 sm:ml-0 text-xs font-medium text-gray-500">
                        Last 30 days
                      </span>
                  ...
                  <div className="flex flex-wrap flex-col items-baseline justify-between gap-x-4 gap-y-2 bg-white px-4 sm:px-6 xl:px-8 py-4 sm:py-0">
                    ...
                    <dd className="flex flex-nowrap sm:flex-wrap items-baseline text-3xl font-semibold text-gray-900 w-full flex-none leading-10 tracking-tight">
                      {formatInstagramMetric(
                        booking.user.instagramAccount?.totalFollowerCount
                      )}
                      <span className="w-full ml-2 sm:ml-0 text-xs font-medium text-gray-500">
                        Last 30 days
                      </span>
                  ...
                  >
                    <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                      ...
                      <div className="ml-4 flex-shrink-0 text-sm leading-6 text-gray-700">
                        {booking.user.instagramAccount?.topCountries.map(
                          (entry: any, index: number) => (
                            <span key={entry.key}>
                              {getFlagEmoji(entry.key)}
                              {index !==
                              (booking.user.instagramAccount?.topCountries
                                .length as number) -
                                1
                                ? ", "
                                : ""}
                    ...
                    <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                      <div className="flex w-0 flex-1 items-center">
                        ...
                        <div className="ml-4 flex min-w-0 flex-1 gap-2">
                          ...
                          <span className="text-gray-400 truncate">
                            Top 3 regional languages
                          </span>
                        </div>
                      </div>
                      <div className="ml-4 flex-shrink-0 text-sm leading-6 text-gray-700">
                        {booking.user.instagramAccount?.topLocale.map(
                          (country: any, index: number) => (
                            <span key={country.key}>
                              {getFlagEmoji(country.key.split("_")[1])}
                              {index !==
                              (booking.user.instagramAccount?.topLocale
                                .length as number) -
                                1
                                ? ", "
                                : ""}
                    ...
                    <li className="flex items-center justify-between py-4 pl-4 pr-5 text-sm leading-6">
                      <div className="flex w-0 flex-1 items-center">
                        ...
                        <div className="ml-4 flex min-w-0 flex-1 gap-2">
                          ...
                          <span className="text-gray-400 truncate">
                            Top 3 gender/age segments
                          </span>
                        </div>
                      </div>
                      <div className="ml-4 flex-shrink-0 text-sm leading-6 text-gray-700">
                        {booking.user.instagramAccount?.topGenderAge.map(
                          (entry: any, index: number) => (
                            <span key={entry.key}>
                              {entry.key}
                              {index !==
                              (booking.user.instagramAccount?.topGenderAge
                                .length as number) -
                                1
                                ? ", "
                                : ""}
        ...
        <div className="mt-8">
          <BusinessBookingActions
            ...
            onUpdateRedirectUrl={`/dashboard/businesses/profile/${booking.business.id}/bookings`}
          />
        </div>
      </div>
    </>
